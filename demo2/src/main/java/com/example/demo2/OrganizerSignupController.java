...
public class OrganizerSignupController {
    ...
    public void SignUp(ActionEvent event) throws IOException {
        ...
        Organizer org = new Organizer(username, password, BirthDate.getValue());
        Database.users.add(org);
    ...
    private boolean isValidPassword(String password) {
        // Must include letters and numbers, 10-15 characters allowed (formatter limits to 15)
    ...
    public void initialize() {
        ...
        // Enforce max 15 characters in both fields
